...
- Use `cargo-tarpaulin` for coverage measurement: `cargo tarpaulin --exclude-files 'crates/cli/*'`
- The CLI binary is excluded from coverage (thin orchestration layer, tested via integration).
